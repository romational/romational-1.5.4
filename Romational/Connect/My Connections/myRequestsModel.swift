...
class MyRequestsModel: NSObject {
    ...
    init(id: Int, compareUserId: Int, nickName: String, firstName: String, lastName: String, image: String, info: String, introStatusMe: String, level1StatusMe: String, level2StatusMe: String, level3StatusMe: String,  level4StatusMe: String, introStatusThem: String, level1StatusThem: String, level2StatusThem: String, level3StatusThem: String,  level4StatusThem: String) {
        ...
        self.introStatusMe    = introStatusMe
    ...
    override var description: String {
        return "ID: \(String(describing: id)), Compare User ID: \(String(describing: compareUserId)) - Name: \(String(describing: nickName)), First Name: \(String(describing: firstName)), Last Name: \(String(describing: lastName)), Image: \(String(describing: image)), Info: \(String(describing: info)),  Intro Status Me: \(String(describing: introStatusMe)), Level 1 Me: \(String(describing: level1StatusMe)), Level 2 Me: \(String(describing: level2StatusMe)), Level 3 Me: \(String(describing: level3StatusMe)), Level 4 Me: \(String(describing: level4StatusMe)),  Intro Status Them: \(String(describing: introStatusThem)), Level 1 Them: \(String(describing: level1StatusThem)), Level 2 Them: \(String(describing: level2StatusThem)), Level 3 Them: \(String(describing: level3StatusThem)), Level 4 Them: \(String(describing: level4StatusThem))"
