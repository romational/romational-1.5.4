...
protocol MyRomtypeProtocol: class {
    func myRomtypeDownloaded(myRomtypeInfo: NSArray)
}


class MyRomtype: NSObject, URLSessionDataDelegate {
    
    //properties
    
    weak var delegate: MyRomtypeProtocol!
    ...
    func parseJSON(_ data:Data) {
        ...
        */
        ...
        DispatchQueue.main.async(execute: { () -> Void in
            ...
            self.delegate?.myRomtypeDownloaded(myRomtypeInfo: jsonResult)
